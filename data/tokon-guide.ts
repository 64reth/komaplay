import type { EditorialDocument } from "../lib/editorial/document";
export const tokonGuide: EditorialDocument = {
  ...
  header: {
    ...
    byline: "INK//:PLAY Editorial",
    hero: {
      id: "hero",
      src: "/assets/clue-shield.png",
      alt: "A gouged round hero shield",
      rights: "Original INK//:PLAY development asset",
    },
    heroCaption: "Development artwork · INK//:PLAY",
  },
  modules: [
    {
      id: "tokon-opening",
    ...
    },
    {
      ...
      content: {
        ...
        source: "INK//:PLAY development asset",
        rights: "Original INK//:PLAY development asset",
        citation: "[P//03]",
      },
    },
